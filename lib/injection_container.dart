...
Future<void> init() async {
  ...
  sl.registerLazySingleton<PrepaRepository>(
      () => PrepaRepositoryImpl(sl())
  );
  ...
  sl.registerLazySingleton(() => PlanningBloc(getPlanningUseCase: sl(), loadCalendarUseCase: sl()));
  sl.registerLazySingleton(() => UserRaceBloc(getUserRace: sl<GetUserRaceUseCase>()));
